...
pub mod plugin_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn event_stream(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::PluginToHost>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::HostToPlugin>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("df.plugin.Plugin", "EventStream"));
...
pub mod plugin_server {
    ...
    pub trait Plugin: Send + Sync + 'static {
        ...
        type EventStreamStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::HostToPlugin, tonic::Status>,
            >
            + Send
            + 'static;
        async fn event_stream(
            &self,
            request: tonic::Request<tonic::Streaming<super::PluginToHost>>,
        ) -> std::result::Result<
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/df.plugin.Plugin/EventStream" => {
                    ...
                    struct EventStreamSvc<T: Plugin>(pub Arc<T>);
                    impl<T: Plugin> tonic::server::StreamingService<super::PluginToHost>
                    for EventStreamSvc<T> {
                        type Response = super::HostToPlugin;
                        ...
                        fn call(
                            ...
                            request: tonic::Request<
                                tonic::Streaming<super::PluginToHost>,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Plugin>::event_stream(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: Plugin> tonic::server::NamedService for PluginServer<T> {
        const NAME: &'static str = "df.plugin.Plugin";
    }
}
