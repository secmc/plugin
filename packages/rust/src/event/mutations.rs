...
impl<'a> EventContext<'a, types::ChatEvent> {
    fn ensure_mutation_exists(&mut self) {
        if !matches!(
            self.result,
            EventResult::Mutated(types::EventResultUpdate::Chat(_))
        ) {
            self.result = EventResult::Mutated(types::EventResultUpdate::Chat(
                types::ChatMutation::default(),
            ));
        }
    }
    ...
    pub fn set_message(&mut self, message: impl Into<Option<String>>) -> &mut Self {
        ...
        if let EventResult::Mutated(types::EventResultUpdate::Chat(ref mut m)) = self.result {
...
impl<'a> EventContext<'a, types::BlockBreakEvent> {
    fn ensure_mutation_exists(&mut self) {
        if !matches!(
            self.result,
            EventResult::Mutated(types::EventResultUpdate::BlockBreak(_))
        ) {
            self.result = EventResult::Mutated(types::EventResultUpdate::BlockBreak(
                types::BlockBreakMutation::default(),
            ));
        }
    }
    ///Sets the `drops` for this event.
    pub fn set_drops(&mut self, drops: impl Into<Option<types::ItemStackList>>) -> &mut Self {
        self.ensure_mutation_exists();
        if let EventResult::Mutated(types::EventResultUpdate::BlockBreak(ref mut m)) = self.result {
            m.drops = drops.into();
        }
        self
    }
...
impl<'a> EventContext<'a, types::PlayerFoodLossEvent> {
    fn ensure_mutation_exists(&mut self) {
        if !matches!(
            ...
            self.result = EventResult::Mutated(types::EventResultUpdate::PlayerFoodLoss(
    ...
    pub fn set_to(&mut self, to: impl Into<Option<i32>>) -> &mut Self {
        self.ensure_mutation_exists();
        if let EventResult::Mutated(types::EventResultUpdate::PlayerFoodLoss(ref mut m)) =
            self.result
        {
            m.to = to.into();
        }
...
impl<'a> EventContext<'a, types::PlayerHealEvent> {
    fn ensure_mutation_exists(&mut self) {
        if !matches!(
            self.result,
            EventResult::Mutated(types::EventResultUpdate::PlayerHeal(_))
        ) {
            self.result = EventResult::Mutated(types::EventResultUpdate::PlayerHeal(
    ...
    pub fn set_amount(&mut self, amount: impl Into<Option<f64>>) -> &mut Self {
        self.ensure_mutation_exists();
        if let EventResult::Mutated(types::EventResultUpdate::PlayerHeal(ref mut m)) = self.result {
...
impl<'a> EventContext<'a, types::PlayerHurtEvent> {
    fn ensure_mutation_exists(&mut self) {
        if !matches!(
            self.result,
            EventResult::Mutated(types::EventResultUpdate::PlayerHurt(_))
        ) {
            self.result = EventResult::Mutated(types::EventResultUpdate::PlayerHurt(
    ...
    pub fn set_damage(&mut self, damage: impl Into<Option<f64>>) -> &mut Self {
        self.ensure_mutation_exists();
        if let EventResult::Mutated(types::EventResultUpdate::PlayerHurt(ref mut m)) = self.result {
...
impl<'a> EventContext<'a, types::PlayerDeathEvent> {
    fn ensure_mutation_exists(&mut self) {
        if !matches!(
            self.result,
            EventResult::Mutated(types::EventResultUpdate::PlayerDeath(_))
        ) {
            self.result = EventResult::Mutated(types::EventResultUpdate::PlayerDeath(
    ...
    pub fn set_keep_inventory(&mut self, keep_inventory: impl Into<Option<bool>>) -> &mut Self {
        self.ensure_mutation_exists();
        if let EventResult::Mutated(types::EventResultUpdate::PlayerDeath(ref mut m)) = self.result
        {
...
impl<'a> EventContext<'a, types::PlayerRespawnEvent> {
    fn ensure_mutation_exists(&mut self) {
        if !matches!(
            self.result,
            EventResult::Mutated(types::EventResultUpdate::PlayerRespawn(_))
        ) {
            self.result = EventResult::Mutated(types::EventResultUpdate::PlayerRespawn(
                types::PlayerRespawnMutation::default(),
            ));
        }
    }
    ///Sets the `position` for this event.
    pub fn set_position(&mut self, position: impl Into<Option<types::Vec3>>) -> &mut Self {
        self.ensure_mutation_exists();
        if let EventResult::Mutated(types::EventResultUpdate::PlayerRespawn(ref mut m)) =
            self.result
        {
...
impl<'a> EventContext<'a, types::PlayerAttackEntityEvent> {
    fn ensure_mutation_exists(&mut self) {
        if !matches!(
            ...
            self.result = EventResult::Mutated(types::EventResultUpdate::PlayerAttackEntity(
    ...
    pub fn set_force(&mut self, force: impl Into<Option<f64>>) -> &mut Self {
        self.ensure_mutation_exists();
        if let EventResult::Mutated(types::EventResultUpdate::PlayerAttackEntity(ref mut m)) =
            self.result
        {
            m.force = force.into();
        }
...
impl<'a> EventContext<'a, types::PlayerExperienceGainEvent> {
    fn ensure_mutation_exists(&mut self) {
        if !matches!(
            ...
            self.result = EventResult::Mutated(types::EventResultUpdate::PlayerExperienceGain(
    ...
    pub fn set_amount(&mut self, amount: impl Into<Option<i32>>) -> &mut Self {
        self.ensure_mutation_exists();
        if let EventResult::Mutated(types::EventResultUpdate::PlayerExperienceGain(ref mut m)) =
            self.result
        {
            m.amount = amount.into();
        }
...
impl<'a> EventContext<'a, types::PlayerLecternPageTurnEvent> {
    fn ensure_mutation_exists(&mut self) {
        if !matches!(
            ...
            self.result = EventResult::Mutated(types::EventResultUpdate::PlayerLecternPageTurn(
    ...
    pub fn set_new_page(&mut self, new_page: impl Into<Option<i32>>) -> &mut Self {
        self.ensure_mutation_exists();
        if let EventResult::Mutated(types::EventResultUpdate::PlayerLecternPageTurn(ref mut m)) =
            self.result
        {
...
impl<'a> EventContext<'a, types::PlayerItemPickupEvent> {
    fn ensure_mutation_exists(&mut self) {
        if !matches!(
            ...
            self.result = EventResult::Mutated(types::EventResultUpdate::PlayerItemPickup(
    ...
    pub fn set_item(&mut self, item: impl Into<Option<types::ItemStack>>) -> &mut Self {
        self.ensure_mutation_exists();
        if let EventResult::Mutated(types::EventResultUpdate::PlayerItemPickup(ref mut m)) =
            self.result
        {
            m.item = item.into();
        }
...
impl<'a> EventContext<'a, types::PlayerTransferEvent> {
    fn ensure_mutation_exists(&mut self) {
        if !matches!(
            ...
            self.result = EventResult::Mutated(types::EventResultUpdate::PlayerTransfer(
                types::PlayerTransferMutation::default(),
            ));
        }
    }
    ///Sets the `address` for this event.
    pub fn set_address(&mut self, address: impl Into<Option<types::Address>>) -> &mut Self {
        self.ensure_mutation_exists();
        if let EventResult::Mutated(types::EventResultUpdate::PlayerTransfer(ref mut m)) =
            self.result
        {
...
impl<'a> EventContext<'a, types::WorldExplosionEvent> {
    fn ensure_mutation_exists(&mut self) {
        if !matches!(
            ...
            self.result = EventResult::Mutated(types::EventResultUpdate::WorldExplosion(
    ...
    pub fn set_entity_uuids(
        ...
        self.ensure_mutation_exists();
        if let EventResult::Mutated(types::EventResultUpdate::WorldExplosion(ref mut m)) =
            self.result
        {
    ...
    pub fn set_blocks(&mut self, blocks: impl Into<Option<types::BlockPosList>>) -> &mut Self {
        self.ensure_mutation_exists();
        if let EventResult::Mutated(types::EventResultUpdate::WorldExplosion(ref mut m)) =
            self.result
        {
